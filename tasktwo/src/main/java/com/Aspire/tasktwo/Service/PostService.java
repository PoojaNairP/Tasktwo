...
public class PostService {
    ...
    public ResponseEntity<Map<String, String>> postData(List<Employee> employees) {
        ...
        for (Employee employee : employees) {
            ...
            //check if there is an employee with the managerid provided
            else if(optionalEmployee.isEmpty()   && !("Account Manager".equals(employee.getDesignation()))){
                errors.put("error_" + employee.getDepartment(), "Department " + employee.getDepartment() + " doesn't have a manager saved yet ");
                continue;
            }
